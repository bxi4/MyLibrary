...
$result = mysqli_query($link, "SELECT * FROM add_author");
?>
<!DOCTYPE html>
<html>
        ...
        <table class="th-view">
          ...
          ?>
            <tr>
              ...
              <td><?php echo $row["date_author"]; ?></td>
              <td><a href="edit_author.php?id=<?php echo $row["id"]; ?>" style="color: white; background-color:#9470a5" >Update</a></td>
            </tr>
          <?php
            $i++;
          }
